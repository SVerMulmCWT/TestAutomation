...
public class RailItineraryLocators {
	...
	//Constructor
	public RailItineraryLocators(EventFiringWebDriver eDriver, ExtentTest reportLogger) {
	...
	protected WebElement trainNumberField;
	protected String trainNumberFieldName = "'Train Number' Field";
