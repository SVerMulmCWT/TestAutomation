...
public class MiscItineraryLocators {
	...
	//Constructor
	public MiscItineraryLocators(EventFiringWebDriver eDriver, ExtentTest reportLogger) {
	...
	protected WebElement tourOperatorField;
	protected String tourOperatorFieldName = "'Tour Operator' Field";
	...
	@FindBy(id="ContentPlaceHolder1_unitTypeTextBox")
	protected WebElement unitTypeField;
	protected String unitTypeFieldName = "'Unit Type' Field";
