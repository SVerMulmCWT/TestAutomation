...
public class ShipItineraryLocators {
	...
	//Constructor
	public ShipItineraryLocators(EventFiringWebDriver eDriver, ExtentTest reportLogger) {
	...
	protected WebElement cruiseLineField;
	protected String cruiseLineFieldName = "'Cruise Line' Field";
