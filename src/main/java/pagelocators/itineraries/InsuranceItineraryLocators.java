...
public class InsuranceItineraryLocators {
	...
	//Constructor
	public InsuranceItineraryLocators(EventFiringWebDriver eDriver, ExtentTest reportLogger) {
	...
	protected WebElement insuranceProviderField;
	protected String insuranceProviderFieldName = "'Insurance Provider' Field";
	...
	@FindBy(id="ContentPlaceHolder1_ProductTypeTextBox")
	protected WebElement productTypeField;
	protected String productTypeFieldName = "'Product Type' Field";
