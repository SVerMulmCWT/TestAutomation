...
import pagelocators.itineraries.TourItineraryLocators;
...
public class TourItineraryPage extends TourItineraryLocators {
	...
	public void verifyTourItinerary(SoftAssert softAssert, String environment, String expectedTourOperator, String expectedDepartureCity, String expectedArrivalCity, String expectedDepartureDate, String expectedUnitType) {
		//Output an info status to the Extent Report & System
		reportLoggerMethods.reportInfo("Verifying the Tour Itinerary Info");
		...
		if (accurateVerifyInfo) {
			reportLoggerMethods.reportSuccessfulCheckpoint("Success: Tour Itinerary Info Matches Expectations");
		} else {
			reportLoggerMethods.reportFailedCheckpoint(failureMessage, "verifyTourItinerary");
		}
	}
