...
public class AirItineraryTest extends TestBase {
	...
	public void testcases_AirItineraryTest(String active, String reportTitle, String environment, String cfaSearch, String segmentNumber, String airline, String flightNumber, String expectedClass, String departureCity, String arrivalCity, String departureDate, String finalResult, String dataRow) {
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			//Navigate to the Air Itinerary Page
			clientfilePage.openAirItineraryPage(segmentNumber);
			
			//Verify the Air Itinerary Info
			airItineraryPage.verifyAirItinerary(checkpoint, airline, flightNumber, expectedClass, departureCity, arrivalCity, departureDate);
			
			//Exit the Itinerary Page
			airItineraryPage.closePage();
