...
public class ShipItineraryTest extends TestBase {
	
	//Define Variable(s)
	SoftAssert checkpoint;
	
	//Constructor
	public ShipItineraryTest() {
		super();
	}
	...
	public void performSetup(String reportTitle, String scriptName) {
		...
		shipItineraryPage = new ShipItineraryPage(eDriver, reportLogger);
	}
	...
	public void beforeClass() {
		...
		excelMethods.setSheetName("Ship Itinerary");
	}
	
	@Test(dataProvider="inputs", dataProviderClass=ExcelMethods.class)
	public void testcases_ShipItineraryTest(String active, String reportTitle, String environment, String cfaSearch, String segmentNumber, String cruseLine, String departureCity, String arrivalCity, String departureDate, String unitType, String finalResult, String dataRow) {
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			performSetup(reportTitle, "testcases_ShipItineraryTest");
			...
			//Navigate to the Ship Itinerary Page
			clientfilePage.openShipItineraryPage(segmentNumber);
			
			//Pause the script for a bit
			genMethods.waitForMilliseconds(1000);
			
			//Verify the Ship Itinerary Info
			shipItineraryPage.verifyShipItinerary(checkpoint, environment, cruseLine, departureCity, arrivalCity, departureDate, unitType);
			
			//Exit the Itinerary Page
			shipItineraryPage.closePage();
