...
public class MiscItineraryTest extends TestBase {
	
	//Define Variable(s)
	SoftAssert checkpoint;
	
	//Constructor
	public MiscItineraryTest() {
		super();
	}
	...
	public void performSetup(String reportTitle, String scriptName) {
		...
		miscItineraryPage = new MiscItineraryPage(eDriver, reportLogger);
	}
	...
	public void beforeClass() {
		...
		excelMethods.setSheetName("Misc Itinerary");
	}
	
	@Test(dataProvider="inputs", dataProviderClass=ExcelMethods.class)
	public void testcases_AirItineraryTest(String active, String reportTitle, String environment, String cfaSearch, String segmentNumber, String supplier, String departureCity, String arrivalCity, String departureDate, String unitType, String finalResult, String dataRow) {
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			performSetup(reportTitle, "testcases_AirItineraryTest");
			...
			//Navigate to the Misc Itinerary Page
			clientfilePage.openMiscItineraryPage(segmentNumber);
			
			//Verify the Misc Itinerary Info
			miscItineraryPage.verifyMiscItinerary(checkpoint, environment, supplier, departureCity, arrivalCity, departureDate, unitType);
			
			//Exit the Itinerary Page
			miscItineraryPage.closePage();
