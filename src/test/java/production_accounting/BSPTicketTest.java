...
public class BSPTicketTest extends TestBase {
	...
	public void testcases_BSPTicketTest(String active, String reportTitle, String environment, String cfaSearch, String documentType, String supplierCode, String supplierName, String documentNumber, String finalResult, String dataRow) {
		...
		if (active.equalsIgnoreCase("y") || active.equalsIgnoreCase("yes")) {
			...
			performSetup(reportTitle, "testcases_BSPTicketTest");
			...
			if (accountingRow == 0) {
				...
				bspTicketPage.verifyBSPTicket(checkpoint, supplierCode, documentNumber);
